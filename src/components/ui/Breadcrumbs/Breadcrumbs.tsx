  ...
  return (
    <div className={classNames(className, styles.wrapper)}>
      {breadсrumbs.length > 1
        ? breadсrumbs.map((breadсrumb, breadсrumbIndex) => <Item key={breadсrumbIndex} name={breadсrumb.name} path={breadсrumb.path} withArrow={!breadсrumbIndex && withArrow} withSlash={!!breadсrumbIndex} />)
