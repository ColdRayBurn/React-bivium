            ...
            <div className={styles.section}>
                ...
                <div className={styles.section__block}>
                    ...
                    <div className={styles.paragraph}>
                        ...
                        производство в Подмосковье, которые оснащены оптимальным набором оборудования, отвечающего
                        последнему слову техники:
                    </div>
                    <div className={styles.list}>
                        <div className={styles.listItem__no_dots}>- компьютерное проектирование и моделирование будущих
                            изделий,
                        </div>
                        <div className={styles.listItems__no_dots}>- термический прогресс и нанесение изображения на
                            ткань,
                        </div>
                    ...
                    <div className={styles.paragraph}>
                        Четкий и методичный подход к созданию разумного производства, находит свое отражение не только в
                        приобретении и применении высокотехнологичного оборудования, но и в точном расчете оптимального
                        количества сотрудников, а также в нашем стремлении к безотходности.
                    </div>
                    <div className={styles.paragraph}>
                        При необходимости, мы не стесняемся обращаться к профессиональным производствам, которым можем
                        всецело доверять, так как наивысшей целью для нас является создание для вас высоко качественного
                        продукта.
                    </div>
                </div>
            </div>
