    ...
    <section className={styles.wrapper}>
      ...
      >
        {slides.map((slide, slideIndex) =>
          <SwiperSlide
            key={slideIndex} className={styles.carouselSlide}
            style={{
          ...
          >
            <div className={classNames(styles.carouselSlideContainer, 'container')}>
              ...
              <div className={styles.carouselSlideFooter}>
                <Button className={styles.carouselSlideButton} variant='negative' onClick={() => router.push('/about-company')}>Узнать больше</Button>
