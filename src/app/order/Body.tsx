    ...
    <div className={styles.wrapper}>
      <Card title='Адрес доставки'>
        <div className={styles.addressForm}>
          <Input className={classNames(styles.addressFormControl, styles.addressFormControl_locality)} placeholder='Населённый пункт*' />
          <Input className={styles.addressFormControl} placeholder='Улица*' />
          <Input className={classNames(styles.addressFormControl, styles.addressFormControl_house)} placeholder='Дом*' />
          <Input className={classNames(styles.addressFormControl, styles.addressFormControl_apartment)} placeholder='Квартира' />
          <TextArea className={classNames(styles.addressFormControl, styles.addressFormControl_comment)} placeholder='Комментарий к заказу' rows={4} />
          <Checkbox className={classNames(styles.addressFormControl, styles.addressFormControl_saveAddress)} text='Добавить адрес в профиль' />
        </div>
        <div className={styles.phonenumberForm}>
          <div className={styles.phonenumberFormWrapper}>
            ...
            <Button className={styles.phonenumberFormButton} variant='negative' icon={false} type='button'>Сохранить и продолжить</Button>
      ...
      <Card title='Откуда Вы узнали о нашем бренде?'>
        ...
        <Button className={styles.surveyButton} variant='negative' icon={false} type='button'>Сохранить</Button>
      </Card>
    </div>
  );
};
